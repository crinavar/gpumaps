...
set output 'plots/2s-sqrt-time-B1.eps'
set title '2-Simplex, Square Root Running Time, {/Symbol r}=1'
set ytics mirror
#unset ytics
...
set pointsize   0.5
set key Left top left reverse samplen 3.0 font "Times,20" spacing 1
...
plot    'data/test1_B1.dat' using 1:11 title "Newton_{{/Symbol r}=1}" with lines ls 1,\
        'data/test1_B1.dat' using 1:15 title "Default_{{/Symbol r}=2}" with lines ls 2,\
        'data/test1_B1.dat' using 1:23 title "Inverse_{{/Symbol r}=4}" with lines ls 3
