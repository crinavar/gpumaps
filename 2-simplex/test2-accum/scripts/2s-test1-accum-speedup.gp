...
set output 'plots/2s-test2-accum-speedup-TITAN-RTX.eps'
set title '2s-accum Kernel Speedup, TITAN RTX, {/Symbol r}=16' font "Times, 24"
#set ytics mirror
unset ytics
...
plot    fbb(x) notitle dashtype 2 lc rgb "black",\
        'data/2s-test1-accum-TITAN-RTX_B16.dat' using 1:($3/$7)   title "{/Symbol l}({/Symbol w})" with lines ls 1,\
        'data/2s-test1-accum-TITAN-RTX_B16.dat' using 1:($3/$11)  title "Rectangle" with lines ls 2,\
        'data/2s-test1-accum-TITAN-RTX_B16.dat' using 1:($3/$15)  title "Trapezoid"                with lines ls 3
