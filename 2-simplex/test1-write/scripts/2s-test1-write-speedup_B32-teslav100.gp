...
set title '2s-write Kernel Speedup, Tesla V100'
#set ytics mirror
unset ytics
...
plot    fbb(x) notitle dashtype 2 lc rgb "black",\
        ...
        'data/2s-test1-write-teslav100_B32.dat' using 1:($3/$23) title "{/Symbol l}" with linespoints ls 1,\
        'data/2s-test1-write-teslav100_B32-recursive.dat' using 1:($3/$31) title "Recursive" with linespoints ls 3,\
        'data/2s-test1-write-teslav100_B32.dat' using 1:($3/$7) title "Avril et. al." with linespoints ls 4
