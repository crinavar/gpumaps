...
set output 'plots/2s-sqrt-running-times.eps'
set title '2-Simplex, Square Root Running Times'
set ytics mirror
#unset ytics
...
plot    'data/test1_B1.dat' using 1:11 title "Newton_{{/Symbol r}=1}" with lines ls 1,\
        'data/test1_B1.dat' using 1:15 title "Default_{{/Symbol r}=1}" with lines ls 2,\
        'data/test1_B1.dat' using 1:23 title "Inverse_{{/Symbol r}=1}" with lines ls 3,\
        'data/test1_B32.dat' using 1:11 title "Newton_{{/Symbol r}=32}" with lines ls 7,\
        'data/test1_B32.dat' using 1:15 title "Default_{{/Symbol r}=32}" with lines ls 8,\
        'data/test1_B32.dat' using 1:23 title "Inverse_{{/Symbol r}=32}" with lines ls 9
