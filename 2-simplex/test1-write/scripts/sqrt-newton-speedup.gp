...
set output 'plots/2s-sqrt-newton-speedup.eps'
set title '2-Simplex, Newton Square Root Performance'
set ytics mirror
#unset ytics
...
plot    'data/test1_B1.dat' using 1:($3/$11) title "{{/Symbol r}=1}" with lines ls 1,\
        'data/test1_B2.dat' using 1:($3/$11) title "{{/Symbol r}=2}" with lines ls 2,\
        'data/test1_B4.dat' using 1:($3/$11) title "{{/Symbol r}=4}" with lines ls 3,\
        'data/test1_B8.dat' using 1:($3/$11) title "{{/Symbol r}=8}" with lines ls 4,\
        'data/test1_B16.dat' using 1:($3/$11) title "{{/Symbol r}=16}" with lines ls 5,\
        'data/test1_B32.dat' using 1:($3/$11) title "{{/Symbol r}=32}" with lines ls 6
