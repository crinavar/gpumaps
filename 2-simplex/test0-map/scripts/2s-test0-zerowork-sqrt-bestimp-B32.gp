...
plot    'data/2s-test0-map-titanx_B32.dat' using 1:($15/$11) title "Newton sqrt()" with linespoints ls 1,\
        'data/2s-test0-map-titanx_B32.dat' using 1:($15/$15) title "CUDA sqrt()" with lines ls 2,\
        'data/2s-test0-map-titanx_B32.dat' using 1:($15/$23) title "Inverse sqrt()" with linespoints ls 3,\
