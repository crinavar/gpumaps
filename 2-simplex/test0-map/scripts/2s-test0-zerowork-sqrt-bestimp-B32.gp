...
set title '2s-zero-work, {{/Symbol l}}({/Symbol w}) Improvement Factor over CUDA sqrt()'
set ytics mirror
#unset ytics
...
plot    'data/2s-test0-map-titanx_B32.dat' using 1:($15/$11) title "Newton" with linespoints ls 1,\
        'data/2s-test0-map-titanx_B32.dat' using 1:($15/$15) title "CUDA" with lines ls 2,\
        'data/2s-test0-map-titanx_B32.dat' using 1:($15/$23) title "Inverse" with linespoints ls 3,\
