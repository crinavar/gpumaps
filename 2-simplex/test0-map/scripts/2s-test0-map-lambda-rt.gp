...
set output 'plots/2s-test0-map-lambda-rt.eps'
set title '2-Simplex, {{/Symbol l}} Mapping Time, Zero-Work'
set ytics mirror
#unset ytics
...
plot    'data/2s-test0-map-titanx_B1.dat' using 1:23 title "{{/Symbol r}} = 1" with lines ls 7,\
        'data/2s-test0-map-titanx_B2.dat' using 1:23 title "{{/Symbol r}} = 2" with lines ls 8,\
        'data/2s-test0-map-titanx_B4.dat' using 1:23 title "{{/Symbol r}} = 4" with lines ls 9,\
        'data/2s-test0-map-titanx_B8.dat' using 1:23 title "{{/Symbol r}} = 8" with lines ls 10,\
        'data/2s-test0-map-titanx_B16.dat' using 1:23 title "{{/Symbol r}} = 16" with lines ls 11 lw 2.0,\
        'data/2s-test0-map-titanx_B32.dat' using 1:23 title "{{/Symbol r}} = 32" with lines ls 12 lw 2.0,\
