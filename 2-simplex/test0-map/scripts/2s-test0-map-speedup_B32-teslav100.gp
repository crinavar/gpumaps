...
set output 'plots/2s-test0-zerowork-speedup-B32-teslav100.eps'
set title '2s-zero-work Kernel Speedup, Tesla V100'
set ytics mirror
unset ytics
...
plot    fbb(x) notitle dashtype 2 lc rgb "black",\
        ...
        'data/2s-test0-map-teslav100_B32.dat' using 1:($3/$23) title "{/Symbol l}" with linespoints ls 1,\
